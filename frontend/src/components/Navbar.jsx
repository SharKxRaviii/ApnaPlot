          ...
          <div className="flex items-center">
            <Link to="/" className="flex-shrink-0 flex items-center gap-2 group">
              ...
              <div className="flex flex-col">
                <span className="font-bold text-2xl text-gray-900 tracking-tight leading-none">ApnaPlot</span>
                <span className="text-[10px] uppercase tracking-widest text-gray-500 font-semibold">Real Estate</span>
              </div>
            </Link>
          </div>
            ...
            {navLinks.map((link) => (
              <Link
                ...
                className={`text-sm font-medium transition-colors hover:text-green-700 ${
                  isActive(link.path) ? 'text-green-700 font-bold' : 'text-gray-500'
                }`}
              >
                {link.name}
              </Link>
