    ...
    <div className="min-h-screen bg-gray-50 pb-20">
      ...
      <div className="bg-white border-b sticky top-0 z-40">
        <div className="max-w-7xl mx-auto px-4 h-16 flex items-center justify-between">
          <Link
            to="/listings"
            className="text-gray-600 hover:text-green-700 flex items-center gap-2 text-sm font-medium"
          >
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="mb-8">
          <div className="flex flex-wrap gap-3 mb-3">
            ...
            <Badge
              className={
                plot.status === "Available" ? "bg-green-600" : "bg-red-500"
              }
            >
              {plot.status}
            </Badge>
          ...
          <p className="flex items-center gap-2 text-gray-500">
            <MapPin className="w-4 h-4" /> {plot.location.address},{" "}
            {plot.location.region}
          </p>
        </div>
          ...
          <div className="lg:col-span-2 space-y-8">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
              ...
              <Card className="p-4 bg-white border-gray-100 shadow-sm text-center">
                ...
                <p className="font-bold text-lg">
                  {formatCurrency(Math.round(plot.price / plot.area))}
                </p>
              </Card>
              <Card className="p-4 bg-white border-gray-100 shadow-sm text-center">
            ...
            <div className="sticky top-24">
              <Card className="p-6 border-t-4 border-t-green-600 shadow-lg">
                ...
                <div className="space-y-3">
                  {/* Call Agent Button */}
                  <a
                    href="tel:917978300902"
                    className="w-full h-12 text-lg bg-green-600 hover:bg-green-700 text-white font-semibold flex items-center justify-center rounded-md"
                  >
                  ...
                  <a
                    ...
                    className="w-full h-12 text-lg border border-green-200 text-green-700 font-semibold hover:bg-green-50 flex items-center justify-center rounded-md"
                  >
                ...
                <p className="text-center text-xs text-gray-400 mt-4">
                  Mention Plot ID{" "}
                  <span className="font-mono text-gray-600">{plot.id}</span>{" "}
                  when calling.
                </p>
              </Card>
              ...
              <div className="mt-6 bg-blue-50 p-4 rounded-xl border border-blue-100">
                <p className="text-sm text-blue-800 font-medium">
                  💡 Pro Tip: Always verify land zoning (Agricultural vs
                  Residential) before paying token money.
                </p>
              </div>
            </div>
          </div>
